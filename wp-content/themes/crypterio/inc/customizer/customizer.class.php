...
if ( ! class_exists( 'STM_Customizer' ) ) {
    class STM_Customizer {
        ...
        public static function init() {
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/google-fonts.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/registration.php';
        ...
        public static function stm_enqueue_custom_fonts() {
            ...
            $all_fonts        = crypterio_google_fonts_array();
            ...
            if ( !empty( $stm_custom_fonts[0] ) and !empty( $font_secondary ) ) {
                ...
                $family[] = $font_first . ':' . $font_variants . '|' . $font_secondary. ':' . $font_variants . $font_subsets;
            ...
            wp_enqueue_style( 'stm-google-fonts', $request, array(), CRYPTERIO_THEME_VERSION );
        }
        ...
        public static function load_controls() {
            ...
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/input_controller.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/checkbox.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/multiple-checkbox.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/code.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/heading.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/select.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/post-type.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/separator.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/text.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/font-family.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/attr.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/font-weight.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/text-transform.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/icon-picker.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/slider.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/socials.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/bg.php';
            require_once CRYPTERIO_CUSTOMIZER_PATH . '/controls/crypto.php';

        }

        public static function admin_scripts() {
            wp_enqueue_style( 'stm-customizer.css', CRYPTERIO_CUSTOMIZER_URI . '/assets/css/customizer.css', array( 'wp-color-picker' ), CRYPTERIO_THEME_VERSION, 'all' );
        }

        public static function customizer_preview_scripts() {
            wp_enqueue_script( 'stm-customizer-preview.js', CRYPTERIO_CUSTOMIZER_URI . '/assets/js/customizer-preview.js', array( 'jquery', 'customize-preview' ), CRYPTERIO_THEME_VERSION, true );
        }

        public static function admin_enqueue_scripts() {

            wp_enqueue_script( 'stm-customizer.js', CRYPTERIO_CUSTOMIZER_URI . '/assets/js/customizer.js', array( 'customize-controls', 'wp-color-picker' ), CRYPTERIO_THEME_VERSION, true );
            ...
            foreach ( $custom_fonts as $font => $info ) {
				...
				$json_file = $basedir . $info['inc' . 'lude'] . '/' . 'selection.json';
        ...
        public static function register_control( $field, $field_data = array(), $section ) {
            ...
            switch ( $field_data['type'] ) {
				...
				case 'stm-crypto':
					self::$customizer->add_control(
						new WP_Customizer_Crypto_Control(
							self::$customizer,
							$field,
							$field_data
						)
